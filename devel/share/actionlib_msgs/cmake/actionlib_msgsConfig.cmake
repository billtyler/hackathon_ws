...
if("TRUE" STREQUAL "TRUE")
  set(actionlib_msgs_SOURCE_PREFIX /home/hackathon_ws/src/common_msgs/actionlib_msgs)
  set(actionlib_msgs_DEVEL_PREFIX /home/hackathon_ws/devel)
  ...
  set(actionlib_msgs_INSTALL_PREFIX /home/hackathon_ws/install)
...
if(NOT "/home/hackathon_ws/devel/include " STREQUAL " ")
  set(actionlib_msgs_INCLUDE_DIRS "")
  set(_include_dirs "/home/hackathon_ws/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'actionlib_msgs' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Tully Foote <tfoote@osrfoundation.org>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'actionlib_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hackathon_ws/src/common_msgs/actionlib_msgs/${idir}'.  Ask the maintainer 'Tully Foote <tfoote@osrfoundation.org>' to fix it.")
    endif()
...
set(actionlib_msgs_EXPORTED_TARGETS "actionlib_msgs_generate_messages_cpp;actionlib_msgs_generate_messages_eus;actionlib_msgs_generate_messages_lisp;actionlib_msgs_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${actionlib_msgs_dep}_FOUND)
      find_package(${actionlib_msgs_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${actionlib_msgs_dep} REQUIRED ${depend_list})
  endif()
