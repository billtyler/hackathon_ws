...
if("TRUE" STREQUAL "TRUE")
  set(stereo_msgs_SOURCE_PREFIX /home/hackathon_ws/src/common_msgs/stereo_msgs)
  set(stereo_msgs_DEVEL_PREFIX /home/hackathon_ws/devel)
  ...
  set(stereo_msgs_INSTALL_PREFIX /home/hackathon_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'stereo_msgs' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Tully Foote <tfoote@osrfoundation.org>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'stereo_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hackathon_ws/src/common_msgs/stereo_msgs/${idir}'.  Ask the maintainer 'Tully Foote <tfoote@osrfoundation.org>' to fix it.")
    endif()
...
set(stereo_msgs_EXPORTED_TARGETS "stereo_msgs_generate_messages_cpp;stereo_msgs_generate_messages_eus;stereo_msgs_generate_messages_lisp;stereo_msgs_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${stereo_msgs_dep}_FOUND)
      find_package(${stereo_msgs_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${stereo_msgs_dep} REQUIRED ${depend_list})
  endif()
