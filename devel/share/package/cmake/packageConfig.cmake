...
if("TRUE" STREQUAL "TRUE")
  set(package_SOURCE_PREFIX /home/hackathon_ws/src/package)
  set(package_DEVEL_PREFIX /home/hackathon_ws/devel)
  set(package_INSTALL_PREFIX "")
  set(package_PREFIX ${package_DEVEL_PREFIX})
else()
  set(package_SOURCE_PREFIX "")
  set(package_DEVEL_PREFIX "")
  set(package_INSTALL_PREFIX /home/hackathon_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'package' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'root <root@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'package' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hackathon_ws/src/package/${idir}'.  Ask the maintainer 'root <root@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/hackathon_ws/devel/lib;/opt/ros/jade/lib)
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    find_package(${package_dep} REQUIRED ${depend_list})
  endif()
  ...
  list(APPEND package_EXPORTED_TARGETS ${${package_dep}_EXPORTED_TARGETS})
endforeach()
