...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_6f4B.pack(_x.voltage, _x.current, _x.charge, _x.capacity, _x.design_capacity, _x.percentage, _x.power_supply_status, _x.power_supply_health, _x.power_supply_technology, _x.present))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.voltage, _x.current, _x.charge, _x.capacity, _x.design_capacity, _x.percentage, _x.power_supply_status, _x.power_supply_health, _x.power_supply_technology, _x.present,) = _struct_6f4B.unpack(str[start:end])
