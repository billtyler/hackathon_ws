...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_f.pack(self.scale))
      ...
      for val1 in self.menu_entries:
        ...
        if python3:
          ...
          buff.write(struct.pack('<I%ss'%length, length, _x))
        buff.write(_struct_B.pack(val1.command_type))
      ...
      for val1 in self.controls:
        ...
        buff.write(_struct_B.pack(val1.independent_marker_orientation))
        _x = val1.description
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.scale,) = _struct_f.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.menu_entries = []
      for i in range(0, length):
        ...
        (val1.command_type,) = _struct_B.unpack(str[start:end])
      ...
      for i in range(0, length):
        ...
        (val1.independent_marker_orientation,) = _struct_B.unpack(str[start:end])
